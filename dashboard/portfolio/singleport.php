...
<head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="../../front_end_end_assets/img/favicon.png">
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="../../public/portfolio/<?= $port['image'] ?>" alt="img">
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img src="../../front_end_assets/img/blog/post_avatar_img.png" alt="img">
                                            </div>
